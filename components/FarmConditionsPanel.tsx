...
import { BeakerIcon, ThermometerIcon, DropletIcon, WindIcon } from './Icons';
    ...
    <Panel title={t.farmConditions}>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <InfoCard 
                icon={<BeakerIcon className="w-6 h-6" />}
                label={t.nutrients}
                value={`${nutrients.nitrogen.toFixed(0)}-${nutrients.phosphorus.toFixed(0)}-${nutrients.potassium.toFixed(0)}`}
            />
            <InfoCard 
